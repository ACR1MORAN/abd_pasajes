...
app.post("/exportar", async (req, res) => {
  try {
    ...
    // Guardar en archivo
    const filePath = path.join(__dirname, "pasajes.csv");
      ...
      layout({
        ...
        body: `
          <div class="text-center py-4">
            ...
            <h1 class="h3 mb-3">¡Exportación completada!</h1>
            <p class="text-muted mb-4">El archivo CSV se generó correctamente</p>

            <div class="alert alert-success text-start mb-4">
              <h5>📁 Archivo generado</h5>
              <div class="bg-light p-3 rounded border">
                <code style="color: #28a745; font-weight: bold;">pasajes.csv</code>
              </div>
              <p class="small mt-2 mb-0">Se encuentra en la carpeta principal de tu proyecto</p>
            </div>

            <div class="d-flex gap-2 justify-content-center mt-4">
              <a class="btn btn-primary" href="/pasajes">← Volver al listado</a>
              <form method="POST" action="/exportar" class="d-inline">
                <button class="btn btn-outline-secondary">🔄 Exportar nuevamente</button>
              </form>
            </div>
          </div>
        `,
